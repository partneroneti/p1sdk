...
public class CallLib {
    ...
    //responses
    private static DocumentBody responseDocumentBody;
    private static StatusObj responseStatusObj;
    private static SessionLiveResponse responseSessionLiveResponse;
    private static LivenessResponse responseLivenessResponse;
    private static CpfObj responseCpfObj;
...
/*
    ...
    public static AuthObj call(String cpfInput, CallBackCapture cb) {
    ...
    public static CpfObj callCpf(Response<AuthObj> response) {
    ...
    public static StatusObj callTransaction(CallBackStatus cbs) {
        ...
        callStatus.enqueue(new Callback<StatusObj>() {
            ...
            public void onResponse(Call<StatusObj> call, Response<StatusObj> response) {
                ...
                responseStatusObj = response.body();
                switch (status) {
    ...
    public static StatusObj callTransactionStatus(CallBackStatus cbc) {
        Call<StatusObj> callStatus = service.checkStatus(transactionId, "Bearer " + authResponse.getObjectReturn().getAccessToken());
        callStatus.enqueue(new Callback<StatusObj>() {
            @Override
            public void onResponse(Call<StatusObj> call, Response<StatusObj> response) {
    ...
    public static SessionLiveResponse callLiveSession(FaceTecSessionResult faceTecSessionResult, FaceTecFaceScanResultCallback faceTecFaceScanResultCallback) {
        ...
        callSession.enqueue(new Callback<SessionLiveResponse>() {
            ...
            public void onResponse(Call<SessionLiveResponse> call, Response<SessionLiveResponse> response) {
                responseSessionLiveResponse = response.body();
        ...
        return responseSessionLiveResponse;
    }
    ...
    public static LivenessResponse liveNess(FaceTecSessionResult faceTecSessionResult, FaceTecFaceScanResultCallback faceTecFaceScanResultCallback) {
        ...
        callLive.enqueue(new Callback<LivenessResponse>() {
            ...
            public void onResponse(Call<LivenessResponse> call, Response<LivenessResponse> response) {
                ...
                if (response.body() != null && response.body().getObjectReturn().getCode() != null) {
                    ...
                    responseLivenessResponse = response.body();
        ...
        return responseLivenessResponse;
    }

    public static DocumentBody sendDocument(PictureResult frente, PictureResult verso) {
